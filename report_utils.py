...
        renames = {}
        
        # Map 'date' (from new sheet) to 'date_str' for processing
        if "date" in df.columns:
            renames["date"] = "date_str"
        
        # Map 'customer' to 'customer_name'
        if "customer" in df.columns:
            renames["customer"] = "customer_name"
        
        # Map 'commodity' to 'commodities_list' for the explode function
        if "commodity" in df.columns:
            renames["commodity"] = "commodities_list"

        # Map 'amount' to 'amount_pkr' for sales calcs
...
        
        # The rest of your original, general renaming logic follows (now updated to use the new names):
...
        # This section is redundant now, but kept for legacy:
...
    
    [Existing logic for explode_commodities remains the same]
    
    """
    df_temp = df.copy()
